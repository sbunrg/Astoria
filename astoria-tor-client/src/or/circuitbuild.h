...
origin_circuit_t *circuit_establish_circuit(uint8_t purpose, extend_info_t *exit, int flags, char* dest_addr);
...
int circuit_all_predicted_ports_handled(time_t now, int *need_uptime,
                                        int *need_capacity);
smartlist_t *return_all_good_exit_server_general(int need_uptime, int need_capacity);
