...
const smartlist_t *return_live_entry_list(cpath_build_state_t *state);
smartlist_t *return_all_but_excluded(smartlist_t *excludedsmartlist, routerset_t *excludedset, router_crn_flags_t flags);
